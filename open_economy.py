...
class MundellFlemingModel:
    ...
    # متغیرهای تجاری خارجی (دهکده سنگ)
    ...
    regime: str = "floating"  # پارامتر نظام ارزی: floating یا fixed
